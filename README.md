...
可以点击 Mind+ 右上角的齿轮查看当前版本。如果版本低于 V2.0.7，请先升级 Mind+。
...
1. 确认电脑使用 Windows 10/11 64 位。
2. 确认 Mind+ 已升级到 V2.0.7 或更高版本。
3. 打开 Mind+。
4. 进入“程序设计”。
5. 选择“Python 积木模式”。
6. 新建一个项目。
7. 开始时左上角会显示 Python 未连接。点击后下载内置 Python，下载完成后点击连接。
...
1. 点击 Mind+ 右上角的齿轮。
2. 在设置中查看版本号，确认版本不低于 V2.0.7。
3. 找到“扩展库开发者模式”并打开。
4. 返回编程页面。
5. 点击左下角橙色的“扩展”。
6. 如果扩展页面左下角已经显示“加载测试扩展”，说明开发者模式已经打开，可以进行下一步。
